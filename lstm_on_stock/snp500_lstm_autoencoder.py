# -*- coding: utf-8 -*-
"""
Created on Tue Dec 31 15:29:54 2019
...
model = Sequential()
model.add(LSTM(32, input_shape = (30,10), return_sequences = True))
...
#load_model("snp500_autoencoder_LSTM_model.h5")
...
model.save("snp500_autoencoder_LSTM_model.h5")
